...
/** Expression which takes three integer arguments. This assumes
...
class TernaryIntExpression(operator: Operator,
                           arg1: GPUExpression,
                           arg2: GPUExpression,
                           arg3: GPUExpression)
        extends GPUExpression(operator, arg1.gpuType, Array(arg1, arg2, arg3))
        with SemanticError
{
  check(arg1.gpuType.isInt, "requires floating point arguments")
  check(arg2.gpuType.isInt, "requires floating point arguments")
  check(arg3.gpuType.isInt, "requires floating point arguments")
