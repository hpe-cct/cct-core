...
//
///** A standalone test case for the experimental accelerated stacked timeseries
//  * visualization.
//  *
//  * Created by gonztobi on 5/12/2014.
//  */
//object TestAcceleratedStackedTimeseriesPanel extends SimpleSwingApplication {
//
//  val Rows = 2
//  val Cols = 3
//
...
//    title = "Test "+classOf[AcceleratedStackedTimeseriesPanel].getSimpleName
//
//    val view = new AcceleratedStackedTimeseriesPanel(memory.fieldType)
//    view.update(memory, memory, 0L)
//
