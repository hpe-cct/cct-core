...
//
///** A standalone test case for the VectorComponentSubpanel visualization.
//  *
//  * Created by gonztobi on 5/19/2014.
//  */
//object TestVectorComponentsSubpanel extends SimpleSwingApplication {
//  val Layers = 2
//  val Rows = 9
//  val Cols = 16
//  val vectorField =
...
//
//    val view = new VectorComponentsSubpanel(vectorField.fieldType)
